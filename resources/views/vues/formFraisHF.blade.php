    ...
    <div class="col-md-12  col-sm-12 well well-md">
        ...
        <div class="form-horizontal">
            ...
            @if($unFrais->id_frais != 0)
                <div class="form-group">
                    <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
                        <a href="{{route('listeFraisHF', $unFrais->id_frais)}}"><button type="button" class="btn btn-default btn-primary"><span class="glyphicon glyphicon-list"></span> Frais hors forfait</button></a>
                    </div>
                </div>
            @endif
