...
alter table frais
   add constraint fk_frais_etat foreign key (id_etat)
      references etat (id_etat);

alter table frais
   add constraint fk_frais_visiteur foreign key (id_visiteur)
...
alter table ligne_fraisforfait
   add constraint fk_ligne_frais foreign key (id_frais)
      references frais (id_frais);
...
alter table stats_prescriptions
   add constraint fk_stats_prescriptions_praticien foreign key (id_praticien)
      references praticien (id_praticien);

alter table stats_prescriptions
   add constraint fk_stats_prescriptions_medicament foreign key (id_medicament)
      references medicament (id_medicament);
