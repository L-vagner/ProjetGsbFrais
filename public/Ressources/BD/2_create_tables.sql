...
create table frais 
(
   id_frais           integer            not null       auto_increment,
   ...
   constraint pk_frais primary key (id_frais)
) engine=innodb character set utf8 collate utf8_general_ci;
...
(
   id_fraishorsforfait integer            not null       auto_increment,
...
(
   ...
   constraint pk_ligne_fraisforfait primary key (id_frais, id_fraisforfait)
) engine=innodb character set utf8 collate utf8_general_ci;
...
(
   ...
   qte_offerte        integer,
   constraint pk_offrir primary key (id_medicament, id_rapport)
) engine=innodb character set utf8 collate utf8_general_ci;
...
(
   ...
   quantite           integer,
   constraint pk_stats_prescriptions primary key (id_praticien, id_medicament, annee_mois)
) engine=innodb character set utf8 collate utf8_general_ci;
